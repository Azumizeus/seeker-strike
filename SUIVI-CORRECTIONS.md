...
| `ECO-1` | 🟡 | **Prix des vaisseaux divisés par 2**, SOL et SKR, pour garder les rapports intacts (0,06 à 0,425 SOL). Le test `skr_sc` vérifie la cohérence des taux : baisser le SOL seul le casserait. | **à tester** |
