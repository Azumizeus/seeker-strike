# -*- coding: utf-8 -*-
"""
Genere seeker-strike-NOAH.html : version AUTONOME, un seul fichier.
...
# ---------- 3. musiques : NON embarquees ----------
# Variante Noah : les 8 MP3 restent des fichiers (3,30 Mo economises).
# Le jeu les charge depuis assets/audio/ ; s'ils manquent, la synthese
# WebAudio prend le relais et le jeu reste jouable.
print("  musiques : laissees en fichiers (assets/audio/)")
